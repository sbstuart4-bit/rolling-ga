...
export function FanAppShell({
  ...
  return (
    <div className="min-h-dvh bg-[#070708] md:flex md:items-center md:justify-center md:p-6">
      <div className="relative mx-auto flex h-dvh w-full max-w-lg flex-col overflow-hidden bg-background md:h-[min(44rem,calc(100dvh-3rem))] md:w-[390px] md:max-w-[390px] md:rounded-[2.15rem] md:border md:border-zinc-600/80 md:p-2 md:shadow-soft-lg">
