    ...
    <MktSectionShell tone="dark" contained={false} className="overflow-x-clip py-0">
      <div className="relative isolate">
        ...
        <div className="relative mx-auto max-w-3xl px-5 py-20 text-center sm:px-8 md:py-28 lg:py-32">
          <MktEyebrow className="text-center">What comes next</MktEyebrow>

          <MktDisplayHeading as="h2" className="mt-4 text-[clamp(1.75rem,5.5vw,3.25rem)]">
            Let&rsquo;s see what happens
            <span className="block text-mkt-purple">when the show doesn&rsquo;t end.</span>
          </MktDisplayHeading>

          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-mkt-muted sm:text-lg">
            We&rsquo;re looking for artists and live-music partners who want to help test a different
            relationship between the show, commerce, and what comes afterward.
          </p>
