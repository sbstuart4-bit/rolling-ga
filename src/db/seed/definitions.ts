...
export const MARISOL_REYES: ArtistDefinition = {
  ...
  slug: "marisol-reyes",
  name: "Marisol Reyes",
  bio: "Bolero and synth. Music for a more tender night.",
  palette: {
    background: "#120E1B",
    surface: "#1C1628",
    foreground: "#F1ECFA",
    accent: "#B892FF",
    accentSecondary: "#7B3CFF",
  },
  mutedForeground: "#9990AC",
  accentForeground: "#120E1B",
  border: "#2C2440",
  fontId: "editorial",
  showMessaging: "Music for a more tender night.",
...
export const PALE_HORSES: ArtistDefinition = {
  id: "art_pale_horses",
  slug: "pale-horses",
  name: "Pale Horses",
  bio: "Dream-pop duo. Reverb-heavy rooms and setlists that feel like half-remembered mornings.",
  palette: {
    background: "#E8E6E1",
    surface: "#F5F3EE",
    foreground: "#2A3338",
  ...
  mutedForeground: "#6B757C",
  accentForeground: "#E8E6E1",
  border: "#D4D0C8",
  fontId: "editorial",
  showMessaging: "We wrote this one for the quiet part of the room.",
  merchPhotographyNote: "Soft daylight, linen textures, desaturated film grain.",
};

export const KITE_AND_ANCHOR: ArtistDefinition = {
  id: "art_kite_anchor",
  slug: "kite-and-anchor",
  name: "Kite & Anchor",
  bio: "Indie folk from the coast. Harmonies that sound like they learned to swim first.",
  palette: {
    background: "#0F1A24",
    surface: "#162432",
    foreground: "#F0EDE4",
    accent: "#E06B54",
    accentSecondary: "#4A90A4",
  },
  mutedForeground: "#8A9BAA",
  accentForeground: "#0F1A24",
  border: "#243444",
  fontId: "dm-serif",
  showMessaging: "Thanks for singing the second verse with us.",
  merchPhotographyNote: "Overcast coastal light, rope and canvas props.",
};

export const DJ_VANTABLACK: ArtistDefinition = {
  id: "art_vantablack",
  slug: "dj-vantablack",
  name: "DJ Vantablack",
  bio: "Warehouse techno. Sub-bass you feel before the kick lands.",
  palette: {
    background: "#000000",
    surface: "#0A0A0A",
    foreground: "#FFFFFF",
  ...
  border: "#1A1A1A",
  fontId: "space-grotesk",
  showMessaging: "Lights down. Volume up.",
  merchPhotographyNote: "UV gel, black seamless, chrome accents only.",
};

export const THE_OSSUARY: ArtistDefinition = {
  id: "art_ossuary",
  slug: "the-ossuary",
  name: "The Ossuary",
  bio: "Post-metal from Brooklyn basements. Slow builds, heavy drops, no mercy.",
  palette: {
    background: "#0A0908",
    surface: "#141210",
    foreground: "#E8E4DC",
  ...
  border: "#2A2622",
  fontId: "space-grotesk",
  showMessaging: "We don't do encores. We do consequences.",
  merchPhotographyNote: "Single hard key, smoke haze, bone-white type on black.",
};
...
export const HISTORICAL_ARTISTS = [
  ...
  DJ_VANTABLACK,
  THE_OSSUARY,
] as const satisfies readonly ArtistDefinition[];
...
export const MARISOL_PRODUCTS: ProductDefinition[] = [
  {
    id: "prd_mr_tee",
    slug: "a-tender-night-tee",
    name: "A Tender Night Tee",
    tagline: "From the current run.",
    story: "Soft-washed cotton with a violet discharge print — the mark from the A Tender Night tour art.",
    category: "apparel",
    accessType: "public",
    priceCents: 4500,
    costCents: 1100,
    sizes: ["S", "M", "L", "XL"],
    tourKey: "a-tender-night",
    stockPerVariant: 280,
  },
  {
    id: "prd_mr_hoodie",
    slug: "more-tender-nights-hoodie",
    name: "More Tender Nights Hoodie",
    tagline: "For the late set.",
    story: "Heavy fleece with embroidered violet mark on the chest — cut slightly long in the body.",
    category: "apparel",
    accessType: "public",
    priceCents: 8000,
    costCents: 2200,
  ...
  {
    id: "prd_mr_hat",
    slug: "marisol-tour-hat",
    name: "Marisol Tour Hat",
    tagline: "Corduroy, violet pin.",
    story: "Corduroy six-panel with an embroidered violet mark and a slide that actually stays put.",
    category: "headwear",
    accessType: "public",
    priceCents: 3500,
    costCents: 900,
  ...
  {
    id: "prd_mr_print",
    slug: "a-tender-night-poster",
    name: "A Tender Night Poster",
    tagline: "Letterpress edition.",
    story: "Two-colour letterpress on uncoated stock from the tour artwork.",
    category: "print",
    accessType: "public",
    priceCents: 2500,
    costCents: 750,
  ...
  {
    id: "prd_mr_city_tee",
    slug: "tender-night-brooklyn-tee",
    name: "Tender Night Brooklyn Tee",
  ...
  {
    id: "prd_mr_vinyl",
    slug: "a-tender-night-lp",
    name: "A Tender Night Vinyl LP",
    tagline: "The full run.",
    story: "180g pressing remastered for vinyl with the original gatefold art.",
    category: "music",
    accessType: "public",
    priceCents: 4000,
    costCents: 1350,
  ...
  {
    id: "prd_mr_scarf",
    slug: "tender-night-silk-scarf",
    name: "Tender Night Silk Scarf",
    tagline: "Jacquard, not a screen print.",
    story: "Silk jacquard with the tour mark woven in — the same pattern from the stage backdrop.",
    category: "accessory",
    accessType: "public",
    priceCents: 5200,
    costCents: 1800,
  ...
  {
    id: "prd_mr_tote",
    slug: "tender-night-tote",
    name: "Tender Night Tote",
  ...
  {
    id: "prd_mr_necklace",
    slug: "tender-night-pendant",
    name: "Tender Night Pendant",
    tagline: "Silver on a fine chain.",
    story: "A small silver violet on an eighteen-inch chain — the same mark from the album art.",
    category: "accessory",
    accessType: "public",
    priceCents: 4600,
    costCents: 1500,
