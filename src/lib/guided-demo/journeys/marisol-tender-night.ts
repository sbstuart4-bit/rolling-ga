...
export const MARISOL_TENDER_NIGHT_STEPS: GuidedDemoStep[] = [
  step({
    step: 1,
    title: "Discover the show",
    whatFanSees:
      "Marisol Reyes is coming to Brooklyn. The fan can learn about the show, but no merch is visible yet.",
    ...
    presenter: {
      ...
      next: "Move to T-14 — tour merch opens on Drops and Brooklyn exclusives become visible but locked.",
    },
  }),
  step({
    step: 2,
    ...
    whatFanSees:
      "Selected Brooklyn-exclusive products are now visible, but still locked.",
    whatChanged:
    ...
    presenter: {
      ...
      pointOut: "A Tender Night tour merch is now on Drops; Brooklyn exclusives show locked on the event page.",
  ...
  step({
    ...
    presenter: {
      ...
      pointOut: "Personalized countdown and “Coming to Brooklyn” relationship treatment.",
  ...
  step({
    step: 4,
    title: "Show day",
    whatFanSees: "The full Brooklyn collection is visible.",
  ...
  step({
    ...
    whatFanSees: "Brooklyn-exclusive merchandise unlocks.",
  ...
  step({
    ...
    route: "/event/{slug}/shop",
    presenter: {
      say: "Every eligible piece is here — core tour merch and Brooklyn exclusives together.",
  ...
  step({
    ...
    whatFanSees:
      "The Tender Night Brooklyn exclusive takes center stage — a piece made for this room on this night.",
    ...
    route: "/event/{slug}/shop",
    presenter: {
      say: "A Tender Night is peaking — the Brooklyn exclusive is the hero of the shop.",
      pointOut: "Tender Night Brooklyn Tee product card and show-night messaging.",
  ...
  step({
    ...
    route: "/product/tender-night-brooklyn-tee?e={slug}",
    presenter: {
  ...
  step({
    ...
    presenter: {
      ...
      next: "Fast-forward — this fan returns for another Marisol show.",
    },
  }),
  step({
    step: 10,
    ...
    whatFanSees:
      "Rolling GA recognizes the fan's prior Brooklyn attendance and purchase history.",
    ...
    route: "/shows",
    presenter: {
      say: "The passport remembers Brooklyn — welcome-back treatment on the next show.",
...
export const MARISOL_TENDER_NIGHT_JOURNEY: GuidedDemoJourney = {
  id: "marisol-tender-night",
  title: "Marisol Reyes — Full Rolling GA Journey",
  ...
  showKey: "marisol-brooklyn",
  steps: MARISOL_TENDER_NIGHT_STEPS,
};
